...
export const AppLogo = (props: AppLogoProps) => {
  ...
  const ownerRoles = ['account-manager', 'sales-representative', 'customer-service-representative', 'business-owner'];
  const appName = `On Premise License management system`;
