...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-manager', 'sales-representative', 'customer-service-representative', 'business-owner'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Licenses', path: '/licenses', entity: 'license', service: AccessServiceEnum.PROJECT, icon: FiKey },
